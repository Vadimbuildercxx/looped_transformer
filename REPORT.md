...
В данной серии эксперементов попробуем заменить как ведет себя **MambaBlock** (из архитектуры **Mamba** взятый из статьи [**Transformers are SSMs: Generalized Models and Efficient Algorithms Through Structured State Space Duality**](https://arxiv.org/pdf/2405.21060) ) интегрированный в общую архитектуру модели. Реализация блока взята из библиотеки `zetascale`. 
